...
class Player(Entity):
    ...
    def __init__(self, pos, groups, obstacle_sprites, create_attack, destroy_attack, create_magic):
        ...
        # weapon
        self.create_attack = create_attack  # this is a function
        self.destroy_attack = destroy_attack  # this is a function
        self.weapon_index = 0
        ...
        # magic
        self.create_magic = create_magic  # this is a function
        self.magic_index = 0
    ...
    def input(self):
        if not self.attacking:
            ...
            if keys[pygame.K_SPACE]:
                ...
                self.create_attack()
                self.weapon_attack_sound.play()  # TODO: should the sound be inside create_attack()?

            # magic input
            if keys[pygame.K_LCTRL]:
                self.attacking = True
                self.attack_time = pygame.time.get_ticks()
                # TODO: improve extraction of magic data
